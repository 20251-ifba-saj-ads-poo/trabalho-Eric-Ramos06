...
public class CadMotoristaController {
    ...
    // Injeção do MasterController
    public void setMasterController(MasterController masterController) {
        this.masterController = masterController;
    }

    // Injeção do ListMotoristaController
    ...
    // Injeção do MotoristaService
    public void setServiceMotorista(MotoristaService serviceMotorista) {
